...
export default function SuccessStoriesSlider() {
  ...
  const current = useMemo(() => STORIES[idx], [idx])
    ...
    <section className="nt-stories">
      <div className="nt-stories__container">
        ...
        <div className="nt-stories__header">
          <div>
            <div className="nt-stories__kicker">Entrepreneurs Who Transformed with Coaching</div>
            <h2 className="nt-stories__title">A SMALL GLIMPSE OF CLIENT SUCCESS STORIES!</h2>
          </div>
        ...
        <div className="nt-stories__card">
          ...
          <div className="nt-stories__more">
            <Link className="nt-stories__moreLink" to="/testimonials">
