    ...
    <section className="nt-servicesShow">
      <div className="nt-servicesShow__container">
        ...
        <div className="nt-servicesShow__heading">
          <div className="nt-servicesShow__kicker">Struggling with growth?</div>
          <h2 className="nt-servicesShow__title">FIX IT WITH EXPERT BUSINESS COACHING & GROWTH SERVICES</h2>
        </div>
